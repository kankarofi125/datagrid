...
export function AppTopBar({ balance, phone }: { balance: number; phone: string }) {
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-white/8 bg-green-deep text-paper shadow-[0_12px_30px_-26px_rgba(10,46,34,.9)] lg:hidden">
      <div className="mx-auto flex min-h-[64px] max-w-lg items-center justify-between gap-3 px-4 py-2.5 sm:px-5">
        ...
        <div className="[&_button]:h-9 [&_button]:w-9 [&_button]:rounded-xl [&_button]:border-white/10 [&_button]:bg-white/[0.05] [&_button]:text-paper">
          <NotificationBell />
        </div>
      </div>
    </header>
